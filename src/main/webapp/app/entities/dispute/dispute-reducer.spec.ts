...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPUTE actions', async () => {
      const arg = { id: 5064 };
    ...
    it('dispatches UPDATE_DISPUTE actions', async () => {
      const arg = { id: 5064 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPUTE actions', async () => {
      const arg = 42666;
