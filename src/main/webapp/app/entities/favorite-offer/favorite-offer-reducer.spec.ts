...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAVORITEOFFER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FAVORITEOFFER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FAVORITEOFFER actions', async () => {
      const arg = { id: 29475 };
    ...
    it('dispatches UPDATE_FAVORITEOFFER actions', async () => {
      const arg = { id: 29475 };
    ...
    it('dispatches PARTIAL_UPDATE_FAVORITEOFFER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FAVORITEOFFER actions', async () => {
      const arg = 42666;
