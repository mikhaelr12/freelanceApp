...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFILEREVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFILEREVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFILEREVIEW actions', async () => {
      const arg = { id: 13565 };
    ...
    it('dispatches UPDATE_PROFILEREVIEW actions', async () => {
      const arg = { id: 13565 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFILEREVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFILEREVIEW actions', async () => {
      const arg = 42666;
