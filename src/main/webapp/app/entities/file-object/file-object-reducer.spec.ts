...
import { defaultValue, IFileObject } from 'app/shared/model/file-object.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FILEOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FILEOBJECT actions', async () => {
      const arg = { id: 448 };
    ...
    it('dispatches UPDATE_FILEOBJECT actions', async () => {
      const arg = { id: 448 };
    ...
    it('dispatches PARTIAL_UPDATE_FILEOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FILEOBJECT actions', async () => {
      const arg = 42666;
