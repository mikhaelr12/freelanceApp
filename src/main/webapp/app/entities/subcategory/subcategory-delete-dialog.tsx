...
import { deleteEntity, getEntity } from './subcategory.reducer';
...
export const SubcategoryDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/subcategory${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freelanceApp.subcategory.delete.question">
        Are you sure you want to delete Subcategory {subcategoryEntity.id}?
      </ModalBody>
      <ModalFooter>
