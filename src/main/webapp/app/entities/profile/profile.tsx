          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Profile Picture <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {profileList.map((profile, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{profile.createdDate ? <TextFormat type="date" value={profile.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                    {profile.lastModifiedDate ? <TextFormat type="date" value={profile.lastModifiedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  ...
                  <td>
                    {profile.profilePicture ? (
                      <Link to={`/file-object/${profile.profilePicture.id}`}>{profile.profilePicture.objectKey}</Link>
                    ) : (
                      ''
                    )}
                  </td>
