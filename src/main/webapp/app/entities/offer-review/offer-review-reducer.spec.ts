...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERREVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERREVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERREVIEW actions', async () => {
      const arg = { id: 13825 };
    ...
    it('dispatches UPDATE_OFFERREVIEW actions', async () => {
      const arg = { id: 13825 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERREVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERREVIEW actions', async () => {
      const arg = 42666;
