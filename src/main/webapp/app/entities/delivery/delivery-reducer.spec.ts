...
import { defaultValue, IDelivery } from 'app/shared/model/delivery.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './delivery.reducer';
