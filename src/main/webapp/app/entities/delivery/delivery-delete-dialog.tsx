...
import { deleteEntity, getEntity } from './delivery.reducer';
...
export const DeliveryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freelanceApp.delivery.delete.question">Are you sure you want to delete Delivery {deliveryEntity.id}?</ModalBody>
      <ModalFooter>
