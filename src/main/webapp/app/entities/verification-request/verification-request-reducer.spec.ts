...
import reducer, {
  ...
  reset,
  updateEntity,
} from './verification-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERIFICATIONREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERIFICATIONREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERIFICATIONREQUEST actions', async () => {
      const arg = { id: 21657 };
    ...
    it('dispatches UPDATE_VERIFICATIONREQUEST actions', async () => {
      const arg = { id: 21657 };
    ...
    it('dispatches PARTIAL_UPDATE_VERIFICATIONREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERIFICATIONREQUEST actions', async () => {
      const arg = 42666;
