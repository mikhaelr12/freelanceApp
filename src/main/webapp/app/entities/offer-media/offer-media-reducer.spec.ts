...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERMEDIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERMEDIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERMEDIA actions', async () => {
      const arg = { id: 23873 };
    ...
    it('dispatches UPDATE_OFFERMEDIA actions', async () => {
      const arg = { id: 23873 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERMEDIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERMEDIA actions', async () => {
      const arg = 42666;
