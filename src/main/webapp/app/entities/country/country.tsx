          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('iso2')}>
                  Iso 2 <FontAwesomeIcon icon={getSortIconByFieldName('iso2')} />
                </th>
                <th className="hand" onClick={sort('iso3')}>
                  Iso 3 <FontAwesomeIcon icon={getSortIconByFieldName('iso3')} />
                </th>
