...
import { deleteEntity, getEntity } from './offer.reducer';
...
export const OfferDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/offer${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="freelanceApp.offer.delete.question">Are you sure you want to delete Offer {offerEntity.id}?</ModalBody>
      <ModalFooter>
