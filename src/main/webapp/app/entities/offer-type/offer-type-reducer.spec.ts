...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERTYPE actions', async () => {
      const arg = { id: 30175 };
    ...
    it('dispatches UPDATE_OFFERTYPE actions', async () => {
      const arg = { id: 30175 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERTYPE actions', async () => {
      const arg = 42666;
