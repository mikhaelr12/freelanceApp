          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Buyer <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Seller <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Offerpackage <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{order.buyer ? order.buyer.login : ''}</td>
                  <td>{order.seller ? order.seller.login : ''}</td>
                  <td>{order.offerpackage ? <Link to={`/offer-package/${order.offerpackage.id}`}>{order.offerpackage.id}</Link> : ''}</td>
