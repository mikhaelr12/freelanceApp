...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERPACKAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERPACKAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERPACKAGE actions', async () => {
      const arg = { id: 2309 };
    ...
    it('dispatches UPDATE_OFFERPACKAGE actions', async () => {
      const arg = { id: 2309 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERPACKAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERPACKAGE actions', async () => {
      const arg = 42666;
