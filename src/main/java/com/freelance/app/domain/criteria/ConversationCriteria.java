 ...
 * in {@link com.freelance.app.web.rest.ConversationResource} to receive all the possible filtering options from
...
public class ConversationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdAt, orderId, distinct);
    }
