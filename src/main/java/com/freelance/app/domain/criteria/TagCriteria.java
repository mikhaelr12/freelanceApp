...
/**
 * Criteria class for the {@link com.freelance.app.domain.Tag} entity. This class is used
 * in {@link com.freelance.app.web.rest.TagResource} to receive all the possible filtering options from
...
public class TagCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdDate, lastModifiedDate, createdBy, lastModifiedBy, distinct);
    }
