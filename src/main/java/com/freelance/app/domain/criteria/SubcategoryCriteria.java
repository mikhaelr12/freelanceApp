...
/**
 * Criteria class for the {@link com.freelance.app.domain.Subcategory} entity. This class is used
 * in {@link com.freelance.app.web.rest.SubcategoryResource} to receive all the possible filtering options from
...
public class SubcategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdDate, lastModifiedDate, createdBy, lastModifiedBy, active, categoryId, distinct);
    }
