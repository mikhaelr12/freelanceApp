...
class OfferReviewRepositoryInternalImpl extends SimpleR2dbcRepository<OfferReview, Long> implements OfferReviewRepositoryInternal {
    ...
    @Override
    public @NotNull Flux<OfferReview> findAll() {
        return findAllBy(null);
    }

    @Override
    public @NotNull Mono<OfferReview> findById(Long id) {
    ...
    @Override
    public <S extends OfferReview> @NotNull Mono<S> save(@NotNull S entity) {
