...
public class OfferMediaSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("media_kind", table, columnPrefix + "_media_kind"));
        columns.add(Column.aliased("is_primary", table, columnPrefix + "_is_primary"));
