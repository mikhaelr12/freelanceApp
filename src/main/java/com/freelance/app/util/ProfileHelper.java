...
public class ProfileHelper {
    ...
    public Mono<Profile> getProfileFromUserLogin(String login) {
        return userRepository.findOneByLogin(login).flatMap(user -> profileRepository.findByUserId(user.getId()));
    }
}
