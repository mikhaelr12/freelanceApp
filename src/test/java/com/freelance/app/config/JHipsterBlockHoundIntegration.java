...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.freelance.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.freelance.app.security.DomainUserDetailsService", "createSpringSecurityUser");
