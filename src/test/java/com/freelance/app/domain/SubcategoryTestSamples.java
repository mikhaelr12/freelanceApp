...
public class SubcategoryTestSamples {
    ...
    public static Subcategory getSubcategorySample1() {
        return new Subcategory().id(1L).name("name1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static Subcategory getSubcategorySample2() {
        return new Subcategory().id(2L).name("name2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
